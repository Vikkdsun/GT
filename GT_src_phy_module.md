...
>但是这里有一个问题，就是如果FD是第四种情况，那么最后一个输出只是一个FD，keep=0，这是不允许的，所以FD要提前一个周期，这意味着他用的是data_pre来控制，所以我们上面的图都应该改为data data_1d data_2d，这里1d就是原来的data 2d是原来的1d data就是pre
